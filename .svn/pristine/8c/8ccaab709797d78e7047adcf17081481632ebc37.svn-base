...
namespace GameStateManagement
{
    ...
    class VictoryScreen : GameScreen
    {
        ...
        /// Constructor.
        /// </summary>
        public VictoryScreen(int nextLevel)
        {
        ...
        public override void LoadContent()
        {
            ...
            backgroundTexture = content.Load<Texture2D>("Background/VictoryBackground");
            dialogue = new VictoryBoxScreen(nextLevel);
            dialogOpen = true;
        }
